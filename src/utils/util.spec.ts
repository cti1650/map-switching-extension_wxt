...
describe('util', () => {
  ...
  describe('getMapPosition', () => {
    ...
    test('yahoo.co.jp', () => {
      expect(
        getMapPosition(
          'https://map.yahoo.co.jp/place?lat=35.6809591&lon=139.7673068&zoom=18'
        )
      ).toMatchObject({
        gcs: 'wgs84',
        lat: 35.6809591,
    ...
    test('maps.gsi.go.jp', () => {
      expect(
        getMapPosition('https://maps.gsi.go.jp/#18/35.6809591/139.7673068/')
      ).toMatchObject({
        gcs: 'wgs84',
        lat: 35.6809591,
        long: 139.7673068,
  ...
  test('getMapLink', () => {
    ...
    expect(getMapLink(position)).toMatchObject({
      ...
      kawabou:
        'https://www.river.go.jp/kawabou/pc/ov?zm=17&clat=35.6809591&clon=139.7673068',
    });
  });
});
